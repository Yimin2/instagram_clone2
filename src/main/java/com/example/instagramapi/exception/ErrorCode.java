...
public enum ErrorCode {
    ...
    OAUTH_TOKEN_FAILD(HttpStatus.UNAUTHORIZED, "OAUTH_TOKEN_FAILD", "OAuth 토큰 발급에 실패했습니다"),
    OAUTH_USER_INFO_FAILD(HttpStatus.UNAUTHORIZED, "OAUTH_USER_INFO_FAILD", "OAuth 사용자 정보 조회에 실패했습니다"),
